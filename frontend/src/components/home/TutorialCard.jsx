...
const TutorialCard = ({ tutorial }) => {
  return (
    <a href={tutorial.videoUrl} target="_blank" rel="noopener noreferrer" className="bg-white rounded-xl overflow-hidden card-hover group cursor-pointer border border-neutral-100 flex flex-col h-full block">
